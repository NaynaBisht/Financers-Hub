...
public class LenderServiceImpl implements LenderService {
    ...
    public LenderServiceImpl(HeartbeatService heartbeatService,
    ...
    @Override
    public Mono<OcenAckResponse> sendLoanApplicationResponse(CreateLoanApplicationRequest request) {
