                    ...
                    <section className="w-full md:w-2/3 pl-3 pb-3">
                        <div className="bg-white p-6 rounded-lg shadow-md mb-8">
                            ...
                            <div className="flex space-x-4">
                                ...
                                <a href="/creditScoreReports" className="bg-[#6B1308] bg-opacity-90 text-white p-4 rounded-lg shadow-lg">
                                ...
                                <a href="/investmentOpportunities" className="bg-[#4B1308] bg-opacity-90 text-white p-4 rounded-lg shadow-lg">
